...
export const HighVoltagePowerSupply = ({ name, schX, schY, showAsSchematicBox }:ModuleProps) => (
  <subcircuit exposeNets name={name} showAsSchematicBox={showAsSchematicBox} schX={schX} schY={schY}>
    ...
    <port name="VDD12V" direction="right" connectsTo={["L2.pin2", "C5.pin1", "D3.anode", "D5.cathode"]} />
    <port name="VDD1" direction="right" connectsTo={["LDO1.pin1"]} />
    ...
    <capacitor name="C5" capacitance="330uF" voltageRating="25V" footprint="kicad:Capacitor_SMD/CP_Elec_6.3x7.7" schX={19} schY={3} />
    {/* 13V Zener Diode in SOD-123 package for 12V rail overvoltage protection */}
    <MMSZ5232B name="D5" schX={21} schY={3} /> {/* Note: parameter/part number updated in BOM to 13V Zener */}
    ...
    <trace name="t_gnd_hv_1" path={["C1.pin2", "C2.pin2"]} />
    <trace name="t_gnd_hv_2" path={["C2.pin2", "D4.anode"]} />
    <trace name="t_gnd_hv_3" path={["D4.anode", "C5.pin2"]} />
    <trace name="t_gnd_hv_4" path={["C5.pin2", "D5.anode"]} />
    ...
    {/* 4. Output Stage (VDD12V & LDO VDD1) Connections */}
    <trace name="t_vout_1" path={["L2.pin2", "C5.pin1"]} />
    <trace name="t_vout_2" path={["C5.pin1", "D3.anode"]} />
    <trace name="t_vout_3" path={["D3.anode", "D5.cathode"]} />
    <trace name="t_ldo_in" path={["L2.pin2", "LDO1.pin8"]} />
    <trace name="t_ldo_gnd_1" path={["LDO1.pin2", "C1.pin2"]} />
    <trace name="t_ldo_gnd_2" path={["LDO1.pin3", "C1.pin2"]} />
    <trace name="t_ldo_gnd_3" path={["LDO1.pin6", "C1.pin2"]} />
    <trace name="t_ldo_gnd_4" path={["LDO1.pin7", "C1.pin2"]} />
