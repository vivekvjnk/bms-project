...
| Field | Value |
|:---|:---|
| **Module Name** | stm32-microcontroller-module |
...
|:---|:---|:---|:---|:---|:---|
| **P1.1** | Input | Power | 12V DC | 12V Aux | Primary external power source (to be regulated by PMIC). |
...
| 12V Aux | 12V | N/A | Automotive grade | External (Vehicle Supply) |
...
|:---|:---|:---|:---|
| 12V Aux Power | Power | Vehicle Battery | Source for PMIC to generate MCU rails. |
